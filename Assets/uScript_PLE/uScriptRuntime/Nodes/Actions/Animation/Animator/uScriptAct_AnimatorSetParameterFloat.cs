...
[FriendlyName("Set Animator Parameter (Float)", "Sets the specified parameter of a Animator Controller on the target GameObject(s).")]
public class uScriptAct_AnimatorSetParameterFloat : uScriptLogic
{
      ...
      )
   {
      foreach (GameObject obj in Target)
      {
         ...
         {
            animController.SetFloat(Name, Value);
         }
         else
         {
