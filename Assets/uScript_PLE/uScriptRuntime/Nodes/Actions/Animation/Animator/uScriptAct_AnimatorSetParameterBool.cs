...
[FriendlyName("Set Animator Parameter (Bool)", "Sets the specified parameter of a Animator Controller on the target GameObject(s).")]
public class uScriptAct_AnimatorSetParameterBool : uScriptLogic
{
      ...
      )
   {
      foreach (GameObject obj in Target)
      {
         ...
         {
            animController.SetBool(Name, Value);
         }
         else
         {
